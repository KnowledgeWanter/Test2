...
{
     internal class BundleManifestItem : TreeViewItem
    {
        internal BundleManifestItem(int id, int depth, string displayName, MessageType type) : base(id, depth, displayName)
        {
            MessageLevel = type;
        }
    ...
    internal class BundleManifestTree : TreeView
    {
        ...
        internal BundleManifestTree(TreeViewState state)
            : base(state)
        {
