...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        internal BundleManifestTab m_ManifestTab;
        ...
        private void OnEnable()
        {
            ...
            {
                m_ManifestTab = new BundleManifestTab();
            }
            m_ManifestTab.OnEnable(subPos);
        ...
        private void OnGUI()
        {
            ...
            switch(m_Mode)
            {
                ...
                case Mode.Inspect:
                    ...
                    break;
                case Mode.Manifest:
                    m_ManifestTab.OnGUI(GetSubWindowArea());
                    break;
                case Mode.Browser:
                default:
        ...
        void ModeToggle()
        {
            ...
            switch(m_Mode)
            {
                ...
                case Mode.Manifest:
                    clicked = GUILayout.Button(m_RefreshTexture);
                    if (clicked)
                        m_ManifestTab.RefreshBundles();
                    break;
            }

            float toolbarWidth = position.width - k_ToolbarPadding * 4 - m_RefreshTexture.width;
            //string[] labels = new string[2] { "Configure", "Build"};
            string[] labels = new string[4] { "Configure", "Build", "Inspect","Manifest" };
