...
namespace Zone.AB
{
    ...
    {/// <summary>
     ///   AssetBundle后缀名
     /// </summary>
        public const string EXTENSION = ".u3d";
        ...
        /// 资源所在根文件夹名
        /// </summary>
        public const string ROOT_FOLDER_NAME = "Bundles";
        ...
        ///   主Manifest文件名称（必须存在）
        /// </summary>
        public const string MAIN_MANIFEST_FILE_NAME = "Bundles";

        /// <summary>
        ///   ResourcesManifest文件名称（必须存在）
        /// </summary>
        public const string RESOURCES_MANIFEST_FILE_NAME = "Manifest";
