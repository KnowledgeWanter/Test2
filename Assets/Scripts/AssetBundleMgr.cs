...
namespace Zone.AB
{
    public class AssetBundleMgr : TSingleton<AssetBundleMgr>
    {
        ...
        public string FindAssetBundleNameByScene(string scene_name)
        {
            ...
            return ResManifest.GetAssetBundleNameByScene(scene_name);
        }
        ...
        internal class AssetAsyncLoader
        {
            ...
            ///   加载一个资源
            /// </summary>
            public IEnumerator StartLoadAssetAsync(AssetBundleMgr mgr)
            {
                if (string.IsNullOrEmpty(AssetBundleName))
                {
                    IsDone = true;
        ...
        internal class SceneAsyncLoader
        {
            ...
            /// 加载一个场景
            /// </summary>
            public IEnumerator StartLoadSceneAsync(AssetBundleMgr mgr)
            {
                if (string.IsNullOrEmpty(AssetBundleName))
                {
                    IsDone = true;
        ...
        IEnumerator Preprocess()
        {
            ...
            Debug.LogError("AssetBundleMgr启动成功！");
        }
        ...
        IEnumerator PreProcessInstallNativeAssets()
        {
            ...
            {
                // 获取所有需要拷贝的文件名
                var itr = newResManifest.Data.Bundles.GetEnumerator();
                while (itr.MoveNext())
                {
                    if (itr.Current.Included)
                    {
                        copyFileList.Add(itr.Current.Name);
                    }
                }
                itr.Dispose();
            }
        ...
        IEnumerator PreprocessLoad()
        {
            ...
            //加载常驻资源
            if (ResManifest != null && ResManifest.Data != null && ResManifest.Data.Bundles != null)
            {
                var asset_bundles = ResManifest.Data.Bundles;
                ...
                while (itr.MoveNext())
                {
                    ...
                    if (itr.Current.Preload && !HasDependencies(itr.Current.Name))
                    {
                        permanentAssetBundles.Add(itr.Current.Name);
                    }
                }
                itr.Dispose();
                ...
                {
                    yield return LoadAssetBundleAsync(itr.Current.Name);
