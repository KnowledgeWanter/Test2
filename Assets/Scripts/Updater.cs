...
namespace Zone.AB
{
    public class Updater : MonoBehaviour
    {
        ...
        {
            if (!AssetBundleMgr.Instance.IsReady)
                return false;
        ...
        public bool StartUpdate(List<string> url_group)
        {
            ...
            if(AssetBundleMgr.IsPlatformSupport)
            {
                StopAllCoroutines();
        ...
        IEnumerator UpdatingUpdateAssetBundle()
        {
            ...
            ResourcesManifest old_resource_manifest = AssetBundleMgr.Instance.ResManifest;
            ...
            //载入MainManifest
            AssetBundleManifest manifest = AssetBundleMgr.Instance.MainManifest;
        ...
        IEnumerator UpdatingDispose()
        {
            ...
            else
            {
                ...
                AssetBundleMgr.Instance.Relaunch();
                var abMgr = AssetBundleMgr.Instance;
